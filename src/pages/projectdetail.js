            ...
            <>
              <div style={{ padding: "5%", backgroundColor: "#14111e" }}>
                ...
                <Grid2
                  ...
                  sx={{ marginBlock: 10 }}
                >
                  {isMobile() ? <PrjdataMobile item={item.challange} heading={'01. The Challange'} /> : <PrjdataWeb item={item.challange} heading={'01. The Challange'} /> }
                  {item.pic2 !== null ? (
                    <img
                      style={{
                  ...
                  {isMobile() ? <PrjdataMobile item={item.solution} heading={'02. The Solution'} /> : <PrjdataWeb item={item.solution} heading={'02. The Challange'} /> }
                  {item.pic3 !== null ? (
                    <img
                      style={{
                        width: isMobile() ? (width * 9) / 10 : (width * 4) / 10,
                   ...
                   {isMobile() ? <PrjdataMobile item={item.results} heading={'03. The Results'} /> : <PrjdataWeb item={item.results} heading={'03. The Results'} /> }
                  {item.pic4 !== null ? (
                    <img
                      style={{
                        width: isMobile() ? (width * 9) / 10 : (width * 4) / 10,
